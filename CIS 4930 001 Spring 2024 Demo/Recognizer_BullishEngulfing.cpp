...
/// <summary>
/// Recognizes whether the candlestick at the index and the one after it is a bullish engulfing pattern
...
/// <returns>bool: Whether the candlesticks follow a bullish engulfing pattern</returns>
bool Recognizer_BullishEngulfing::Recognize(List<SmartCandlestick^>^ lscs, int index)
{
